<template>
  <div class="app-container">
    <h3>
      <a href="https://codepen.io/henrywr/pen/jGaqVe" target="_blank"
        >来源: https://codepen.io/henrywr/pen/jGaqVe</a
      >
    </h3>
    <svg
      id="500_Bill"
    ...
    >
      ...
      <g id="Bill">
        ...
        <g id="Eyes" fill="#263D52">
          <circle
            id="eyes-left"
            style="transform-origin: 228.391px 126.333px"
            cx="228.4"
            cy="126.3"
            r="5.9"
          />
          <circle
            id="eyes-right"
            style="transform-origin: 266.289px 126.333px"
            cx="266.3"
            cy="126.3"
            r="5.9"
          />
      ...
      <g id="smokes" fill="#D5DADB">
        ...
        <use
          xlink:href="#ember-emit"
          class="emitted-ember emitted-ember-alt"
        ...
        <circle
          id="smoke-base-2"
          style="-moz-transform-origin: 480px 70.4px"
          class="smoke"
          cx="480"
          cy="70.4"
          r="8"
        ...
        <circle
          id="smoke-float-2"
          style="-moz-transform-origin: 464.9px 53.3px"
          class="emitted-ember"
          fill-opacity=".8"
          cx="464.9"
          cy="53.3"
        ...
        <circle
          id="smoke-float-3"
          style="-moz-transform-origin: 471.1px 47.9px"
          class="emitted-ember"
          fill-opacity=".8"
          cx="471.1"
          cy="47.9"
        ...
        <circle
          id="smoke-float-5"
          style="-moz-transform-origin: 470.4px 28.2"
          class="emitted-ember"
          fill-opacity=".3"
          cx="470.4"
          cy="28.2"
      ...
      <g id="fire" clip-path="url(#flame-mask)">
        <path
          id="flame-back"
          style="-moz-transform-origin: 470.729px 93px"
          class="flame-front"
          fill="#D14D40"
        ...
        <path
          id="flame-front-left"
          style="-moz-transform-origin: 462.55px 93px"
          class="flame-front"
          fill="#FB6A4F"
        ...
        <path
          ...
          class="flame-front anim-delay-1"
          fill="#FB6A4F"
          d="M497 93l-9.2-35.5L461.3 93z"
        />
        <path
          id="flame-inner-left"
          style="-moz-transform-origin: 461.677px 97px"
          class="flame-inner"
          fill="#FFD657"
        ...
        <path
          ...
          style="-moz-transform-origin: 476.268px 97px"
          class="flame-inner"
          fill="#FFD657"
